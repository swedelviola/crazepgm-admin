      ...
      <div class="col-md-8">
        <div class="card " style="margin:20px 15px 20px 15px">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="editp5.php">

              <?php
              $sql="SELECT ename,end_date from event where e_id='$e_id'";
            ...
            <?php }} ?>
              ...
              <button type="submit" class="btn btn-primary" formaction="editp5.php">Update</button>
